...
<div class="main">
  ...
  <tr>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style5">File Name </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style5">Owner Name </div></td>
         <td width="293" bgcolor="#FF0000"><div align="center" class="style5">MAC </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style5">Cloud Name </div></td>
      <td width="293" bgcolor="#FF0000"><div align="center" class="style5">VM Name </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style5">Secret Key </div></td>
    <td width="115" bgcolor="#FF0000"><div align="center" class="style5">Rank </div></td>
    <td width="205" bgcolor="#FF0000"><div align="center" class="style5">Date & Time</div></td>
  </tr>
...
String cn=(String) application.getAttribute("cloudName");
  ...
  <tr>
    ...
    <td><div align="center" class="style6"><%=s4%></div></td>
	  ...
	  <td><div align="center" class="style6"><%=s9%></div></td>
    	  <td><div align="center" class="style6"><%=s10%></div></td>
  </tr>
